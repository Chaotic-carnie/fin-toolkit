...
CREATE TABLE "StressPack" (
    ...
    CONSTRAINT "StressPack_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "Run_runType_idx" ON "Run"("runType");
...
-- CreateIndex
CREATE INDEX "StressPack_userId_idx" ON "StressPack"("userId");
...
-- AddForeignKey
ALTER TABLE "StressPack" ADD CONSTRAINT "StressPack_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE CASCADE;
